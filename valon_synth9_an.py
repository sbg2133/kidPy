...
"""
#hacks to use anritsu instead of valon
from instruments import anritsu2 as anritsu
lo_port = 2
...
class Synthesizer:
    ...
    def set_frequency(self, synth, freq, chan_spacing = 10.):
        ...
        """
        if synth == lo_port:
            self.an.set_frequency(freq*10**6)
            sleep(.1)
            return True
        else:
            self.conn.open()
